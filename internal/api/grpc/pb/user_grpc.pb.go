...
func (c *userServiceClient) AddUser(ctx context.Context, in *AddUserReq, opts ...grpc.CallOption) (*User, error) {
...
func (UnimplementedUserServiceServer) AddUser(context.Context, *AddUserReq) (*User, error) {
